...
for experiment in range(100):
    ...
    # with open(os.path.join(os.environ.get('MSC_PROJECT'), f'notebooks/experiments/vonmises_vs_cosine/experiments/exp_{experiment}_cpu4_1.pickle'), 'wb') as fh:
    ...
    to_save['spiking_cx_vm'] = spiking_cx_vm.extract_data()
    to_save['spiking_cx_cos'] = spiking_cx_cos.extract_data()
    with open(os.path.join(os.environ.get('MSC_PROJECT'), f'notebooks/experiments/vonmises_vs_cosine/experiments/exp_{experiment}_cpu4_2.pickle'), 'wb') as fh:
        pickle.dump(to_save, fh, protocol=3)
