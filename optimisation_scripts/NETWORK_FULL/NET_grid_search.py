...
MOTOR_stimulus = TimedArray(MOTOR_spike_rates*motors.T*Hz, dt=1.*time_step*ms)
...
def run_simulation_NET(tauE_, wE_, tauI_, wI_, 
    ...
    target_spike_monitor_CPU4 = SpikeMonitor(Target, name='CPU4_target_spike_monitor')
    ...
    gf_CPU4 = metric.compute_gamma_factor(model_spike_monitor_CPU4, target_spike_monitor_CPU4, time, 
